 ...
 * @author samue
 */
public class Nomeprovisiorio extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public Nomeprovisiorio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nomeprovisiorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nomeprovisiorio().setVisible(true);
            }
        });
    }
